...
<a href="main-page.php"><img class="img-ini" src="logo sfundo.png" style="position: absolute; left:-1.5px ; width: 6%;" alt=""></a>
    <nav id="menuzinho0" class="dp-menu " style="position:absolute; left: -30%; z-index:99999;" >
...
<li class="sub-categoria1">
    ...
    <div class="container"><iframe  src="https://www.jogos360.com.br/tank_wars_2d_2_players.htmlhttps://www.jogos360.com.br/stick_duel_revenge.html"></iframe></div>
</body>
<script>
    ...
    if (screen.width === 1024 && screen.height === 768) {
            // Redireciona para main-page_1024.php
            navMenu.style.left = '-33%';
        }
        const isLoggedIn = <?php echo isset($_SESSION['email']) ? 'true' : 'false'; ?>;
          if (isLoggedIn) {
                navMenu.style.left = '-32%';
          }
</script>
</html>